...
namespace ForgeDerivative.Services
{
    ...
    {
        public async Task Download(string urn, string accessToken)
        {
            ...
            foreach (Resource resource in resourcesToDownload)
            {
                ...
                if (response.StatusCode != System.Net.HttpStatusCode.OK)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine(string.Format("Error downloading {0}: {1}",
                ...
                else
                {
                    ...
                    // string pathToSave = Directory.GetCurrentDirectory()+"\\temp";
                    string pathToSave = Path.Combine(Directory.GetCurrentDirectory(), resource.LocalPath);
